...
using SallesMenWeb.Models.Enums;

namespace SallesMenWeb.Data
{
    public class SeedingService
    {
        private SallesMenWebContext _context;

        public SeedingService(SallesMenWebContext context) // dependence injection
        {
            _context = context;
        }

        public void Seed() // DB seeding function
        {
